...
export default function But({ item }) {
  ...
  return (
    <>
      <div onClick={() => setOpen(true)} className="cursor-pointer">
        <div className="group bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden m-2">
          ...
          <div className="p-4">
            ...
            <p className="text-yellow-500 text-sm mt-2 cursor-pointer hover:underline">
              $ {item?.prix}
            </p>
          </div>
        </div>
